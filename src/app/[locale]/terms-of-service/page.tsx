...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Windrose Wiki",
    description: "Read the Terms of Service for Windrose Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    keywords: [
      'terms of service',
      "Windrose Wiki terms",
      'user agreement',
    ...
    openGraph: {
      ...
      title: "Terms of Service - Windrose Wiki",
      description: "Terms and conditions for using Windrose Wiki.",
      images: [
        {
          url: ogImage,
          width: 1200,
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Windrose Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Windrose Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Windrose Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Windrose Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Windrose". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Windrose Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Windrose. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Windrose Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Windrose. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, WINDROSE WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Windrose Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@windrosewiki.wiki</a>
            </p>
            <p>
