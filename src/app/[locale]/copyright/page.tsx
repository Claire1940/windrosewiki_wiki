...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Windrose Wiki',
    description: 'Copyright and intellectual property information for Windrose Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Windrose Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Windrose Wiki',
      description: 'Copyright and intellectual property information for Windrose Wiki.',
      images: [
        {
          url: ogImage,
          width: 1200,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Windrose Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Windrose Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Windrose Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Windrose Developers</strong> - Creators of the Windrose game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Windrose</strong> - Trademark of the game developers</li>
              <li><strong>Windrose Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Windrose Wiki.
            </p>
            ...
            <p>
              ...
              Windrose Wiki<br />
              Email: <a href="mailto:dmca@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@windrosewiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Windrose Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Windrose Wiki (windrosewiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@windrosewiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@windrosewiki.wiki</a>
            </p>
            <p>
