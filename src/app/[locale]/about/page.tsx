...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Windrose Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Windrose Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Windrose Steam game.',
    keywords: [
      'about Windrose Wiki',
      'Windrose community',
      'Steam game wiki',
    ...
    openGraph: {
      ...
      title: 'About Windrose Wiki',
      description: 'Learn about our mission to provide the best Windrose game resources and guides.',
      images: [
        {
          url: ogImage,
          width: 1200,
    ...
    twitter: {
      ...
      title: 'About Windrose Wiki',
      description: 'Learn about our mission to provide the best Windrose game resources.',
      images: [ogImage],
    },
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Windrose
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Windrose Wiki</h2>
            <p>
              Windrose Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Windrose". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Windrose Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Windrose players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Windrose Wiki as the <strong>go-to destination</strong> for every Windrose player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Windrose Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Windrose Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Windrose as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Windrose mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Windrose Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Windrose or any official entities.
            </p>
            <p>
            ...
            <p>
              Windrose Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@windrosewiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@windrosewiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@windrosewiki.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@windrosewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@windrosewiki.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Windrose news.
